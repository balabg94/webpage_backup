...
os.environ['opentabs'] = '/home/bg/.mozilla/firefox/2dmmjsje.default-1569575256935/sessionstore-backups/recovery.jsonlz4'
...
def backup_urls():
    ...
    url_new = write_file(now, urls)
    return 'Done. Recorded {} urls'.format(url_new)

def write_file(now, urls):
